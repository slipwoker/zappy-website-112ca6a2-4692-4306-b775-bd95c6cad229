...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    function validateField(input) {
      ...
      if (input === nameInput && value && value.length < 2) {
        showError(input, 'Name must be at least 2 characters');
        return false;
      }
      
      if (input === messageInput && value && value.length < 10) {
    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      [nameInput, emailInput, messageInput, phoneInput].forEach(function(input) {
        if (input) {
      ...
      if (isValid) {
        ...
        if (submitButton) {
          ...
          setTimeout(function() {
            ...
            successMessage.style.cssText = 'color: #27ae60; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #d5f5e3; border-radius: 4px; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '112ca6a2-4692-4306-b775-bd95c6cad229',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '112ca6a2-4692-4306-b775-bd95c6cad229';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '112ca6a2-4692-4306-b775-bd95c6cad229';
